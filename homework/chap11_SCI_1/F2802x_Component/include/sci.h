...
inline _Bool SCI_isRxDataReady(SCI_Handle sciHandle)
{
    SCI_Obj *sci = (SCI_Obj *)sciHandle;
    _Bool status;
...
void SCI_setTxDelay(SCI_Handle sciHandle,const uint16_t delay);
...
inline _Bool SCI_isTxReady(SCI_Handle sciHandle)
{
    SCI_Obj *sci = (SCI_Obj *)sciHandle;
    _Bool status;
