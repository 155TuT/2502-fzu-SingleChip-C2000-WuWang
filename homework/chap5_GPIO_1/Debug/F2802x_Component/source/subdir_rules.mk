...
F2802x_Component/source/%.obj: ../F2802x_Component/source/%.asm $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"C:/ti/ccs1040/ccs/tools/compiler/ti-cgt-c2000_20.2.5.LTS/bin/cl2000" -v28 -ml -mt --include_path="C:/ti/ccs1040/ccs/tools/compiler/ti-cgt-c2000_20.2.5.LTS/include" --include_path="C:/Users/cai/OneDrive/31-福大控制课题组协同办公/03-教材/微控制器原理及应用/4程序案例/chap5_GPIO_1" -g --diag_warning=225 --diag_wrap=off --display_error_number --abi=coffabi --preproc_with_compile --preproc_dependency="F2802x_Component/source/$(basename $(<F)).d_raw" --obj_directory="F2802x_Component/source" $(GEN_OPTS__FLAG) "$<"
