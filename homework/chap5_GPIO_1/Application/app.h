...
TARGET_EXT void KEY_Control_LED(void);      //简易按键测试程序
TARGET_EXT void KEY_Control_LED_1(void);      //短按、长按、双击
TARGET_EXT void KEY_Control_LED_2(void);      //按键控制两种显示方式
TARGET_EXT void KEY_Control_LED_3(void);      //按键去抖动
