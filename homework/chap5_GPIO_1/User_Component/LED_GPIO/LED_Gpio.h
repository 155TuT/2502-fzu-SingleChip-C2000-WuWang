...
TARGET_EXT void LED_Display(void);       //灯闪烁控制
TARGET_EXT void LED_Display1(void);      //矩阵实现灯控制
TARGET_EXT void LED_Display2(void);     //矩阵实现跑马灯
TARGET_EXT void LED_Display3(void);     //数组实现跑马灯
/*******************************************/
