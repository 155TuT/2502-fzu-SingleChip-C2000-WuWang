...
TARGET_EXT void LED_DISPLAY11(void);
TARGET_EXT void LED_DISPLAY22(void);
TARGET_EXT void LED_DISPLAY33(void);
TARGET_EXT void LED_DISPLAY(void);
TARGET_EXT void LED_DISPLAY5(void);


TARGET_EXT void Delay1(uint32_t time);
TARGET_EXT uint32_t  time_test;

TARGET_EXT uint32_t LED_TIME_DELAY_COUNTER;
TARGET_EXT uint32_t LED_TIME_DELAY;
TARGET_EXT uint16_t Line;
TARGET_EXT uint16_t  display_mode;      //

TARGET_EXT void LED_Control2(void);
